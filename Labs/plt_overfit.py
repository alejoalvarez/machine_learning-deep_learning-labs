...
class overfit_example():
    ...
    def linear_regression(self):
        ...
        # Features were already standardized above; ``normalize`` was removed
        # from scikit-learn's Ridge API.
    ...
    def logistic_regression(self):
        ...
        if not self.regularize or self.lambda_ == 0:
            # scikit-learn now represents no regularization with None rather
            # than the former string value 'none'.
