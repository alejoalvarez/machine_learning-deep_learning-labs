...
def print_pred_movies(y_p, item, movie_dict, maxcount=10):
    ...
    for i in range(0, y_p.shape[0]):
        ...
        title = movie_dict[movie_id].get('title', f"Unknown (id {movie_id})")
        genres = movie_dict[movie_id].get('genres', "Unknown")
    ...
    for i in range(0, y.shape[0]):
        if y[i, 0] != 0:  # zero means not rated
            ...
            disp.append([y_p[i, 0], y[i, 0],
                         ...
                         movie_id,
                         movie_dict[movie_id].get('title', f"Unknown (id {movie_id})"),
                         movie_dict[movie_id].get('genres', "Unknown")])
