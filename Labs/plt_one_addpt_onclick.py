...
#   @output.capture()  # debug
    ...
    def resize_sq(self, bcid):
        """Keep compatibility with Matplotlib's CheckButtons widget.

        Matplotlib 3.9 removed the private ``rectangles`` and ``lines``
        attributes used by the original cosmetic checkbox-resizing code.
        The default checkbox size works across supported versions.
        """
        return None
